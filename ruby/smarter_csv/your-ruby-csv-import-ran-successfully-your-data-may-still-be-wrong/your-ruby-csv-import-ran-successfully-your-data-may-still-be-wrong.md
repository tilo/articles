...
And if you're ready to switch, SmarterCSV 1.16 is out — now 1.8×–8.6× faster than CSV.read end-to-end, with a bad-row quarantine system, and  instrumentation hooks:
